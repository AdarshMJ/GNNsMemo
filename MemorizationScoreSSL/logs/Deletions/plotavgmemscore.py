...
def plot_averaged_results(csv_files, save_path='memorization_averaged.png'):
    """
    ...
    plt.title('Model Alignment Loss vs. Memorization (Averaged across seeds)')
    plt.legend()
    plt.tight_layout()
...
if __name__ == "__main__":
    ...
    csv_files = [f'mem{i}.csv' for i in range(1, 6)]
    ...
    if not existing_files:
        ...
        print("Looking for files: mem1.csv, mem2.csv, mem3.csv, mem4.csv, mem5.csv")
