...
# This script generates SBM graphs with fixed homophily and varying informativeness
# and then runs the analysis to study memorization

# Configuration
HOMOPHILY=-0.1           # Fixed homophily level
...
DATASET_PATH="data/pyg_sbm" # Path for generated datasets
...
echo "=============================================="
echo "Step 1: Generating SBM graphs with fixed homophily ($HOMOPHILY)"
echo "and varying informativeness levels"
echo "=============================================="
